    ...
    <>
      <div className="mt-2 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
        <IconContext.Provider value={{ size: "1.5em" }}>
          ...
          <label className="border p-2 flex rounded-2-xl gap-1 items-center cursor-pointer">
            <input type="checkbox" name="access" onChange={handleCbClick} />
          ...
          <label className="border p-2 flex rounded-2-xl gap-1 items-center cursor-pointer">
            <input type="checkbox" name="dishwasher" onChange={handleCbClick} />
          ...
          <label className="border p-2 flex rounded-2-xl gap-1 items-center cursor-pointer">
            <input type="checkbox" name="fireplace" onChange={handleCbClick} />
